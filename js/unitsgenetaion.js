$(document).ready(function(){
    ...
    const maxlessontime=2
    const lecturers = [
        { name: 'Dr. Smith', maxConsecutiveHours: maxlessontime, assignedSlots: [] },
        { name: 'Prof. Johnson', maxConsecutiveHours: maxlessontime, assignedSlots: [] },
        { name: 'Dr. Williams', maxConsecutiveHours: maxlessontime, assignedSlots: [] }
    ];
    ...
    const units = [
        { name: 'Math', lecturer: 'Dr. Smith', hoursPerDay: 4, assignedSlots: [] },
        { name: 'Physics', lecturer: 'Prof. Johnson', hoursPerDay: 4, assignedSlots: [] },
        { name: 'Statistics', lecturer: 'Dr. Williams', hoursPerDay: 4, assignedSlots: [] },
        { name: 'Calculus', lecturer: 'Dr. Smith', hoursPerDay: 4, assignedSlots: [] },
        { name: 'Algebra', lecturer: 'Prof. Johnson', hoursPerDay: 4, assignedSlots: [] },
        { name: 'Geometry', lecturer: 'Dr. Williams', hoursPerDay: 4, assignedSlots: [] }
    ];
    
    const timeSlots = ['7AM-9AM', '9AM-11AM', '11AM-1PM', '2PM-4PM', '4PM-6PM','6PM-8PM'];
    ...
    function canAssign(lecturer, slot) {
    ...
    function generateTimetable() {
        days.forEach(day => {
            units.forEach(unit => {
                ...
                timeSlots.forEach(slot => {
                    if (remainingHours > 0 && canAssign(lecturer, slot) && !timetable[day][slot].unit) {
                        timetable[day][slot] = { room: rooms[0], course: null, unit: unit.name, lecturer: lecturer.name };
